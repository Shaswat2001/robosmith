...
from forge.config import RunState, TaskSpec
from forge.stages.evaluation import EvalReport
...
def _write_reward_file(
    ...
    header = f'''"""
Reward function generated by Embodied Agent Forge.
...
def _write_report_card(
    ...
    lines.append("---")
    lines.append("*Generated by [Embodied Agent Forge](https://github.com/Shaswat2001/embodied-agent-forge)*")
